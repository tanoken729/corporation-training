            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="register">
                        ...
                        <div class="form-group row">
                            <label for="postal" class="col-md-4 col-form-label text-md-right">{{ __('郵便番号(ハイフンなし)') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="tel" class="col-md-4 col-form-label text-md-right">{{ __('電話番号(ハイフンなし)') }}</label>
