...
//        if(dayColor.style.backgroundColor=='pink'){
//           document.getElementById( e.target.dataset.date.slice(8,10) ).style.backgroundColor='white';
//        }else{
