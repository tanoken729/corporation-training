...
<button type="button" class="btn btn-primary" onclick="window.location.href='/plan/add'">プラン変更</button><br>
<button type="button" class="btn btn-primary" onclick="window.location.href='/reservation/edit_admin'">予約情報変更</button><br>
